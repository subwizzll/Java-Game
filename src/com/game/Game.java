...
public class Game extends Canvas implements Runnable{
    ...
    public static final int WIDTH = 1366;               // initialize window size constants
    ...
    public Game() {                                     // game constructor
        ...
        handler = new Handler();                        // instantiate object handler
        ...
        hud = new HUD();                                // instantiate HUD

        handler.addObject(new Player(WIDTH/2-32,HEIGHT/2-32,GameObjectID.Player));
        handler.addObject(new Enemy(WIDTH/2+32,HEIGHT/2+32,GameObjectID.Enemy));
